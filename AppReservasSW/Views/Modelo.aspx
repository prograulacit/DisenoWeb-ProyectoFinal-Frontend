<%@ Page Async="true" Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Modelo.aspx.cs" Inherits="AppReservasSW.Views.Modelo" %>
    ...
    <table class="form_table row justify-content-center">
        ...
        <tr>
            <td class="modal-sm" style="width: 190px">
                Color</td>
            <td>
                <asp:TextBox class="form-control" ID="TextBox_color" runat="server"></asp:TextBox>
            </td>
            <td>&nbsp;</td>
        </tr>
        <tr>
