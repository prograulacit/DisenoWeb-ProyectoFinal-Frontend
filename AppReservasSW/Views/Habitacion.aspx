...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <asp:GridView ID="grdHabitacion" runat="server" BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" ForeColor="Black" GridLines="Vertical">
    ...
    <table style="width:100%;">
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtCodigo" runat="server" type="number"></asp:TextBox>
            </td>
            <td>&nbsp;</td>
        </tr>
        <tr>
            ...
            <td>
                <asp:DropDownList ID="DropDownList_HotelRelacion" runat="server">
                </asp:DropDownList>
            </td>
            <td>&nbsp;</td>
        </tr>
        <tr>
            ...
            <td>
                <asp:TextBox ID="TextBox_NumeroHabitacion" runat="server" type="number"></asp:TextBox>
            </td>
            <td>&nbsp;</td>
        </tr>
        <tr>
            ...
            <td>
                <asp:DropDownList ID="DropDownList_capacidad" runat="server">
                </asp:DropDownList>
            </td>
            <td>&nbsp;</td>
        </tr>
        <tr>
            ...
            <td>
                <asp:TextBox ID="TextBox_TipoHabitacion" runat="server" maxlength="10"></asp:TextBox>
            </td>
            <td>&nbsp;</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="TextBox_Estado" runat="server" maxlength="1"></asp:TextBox>
            </td>
            <td>&nbsp;</td>
        </tr>
        <tr>
            ...
            <td>
                <asp:TextBox ID="TextBox_precio" runat="server" type="number"></asp:TextBox>
            </td>
            <td>&nbsp;</td>
        </tr>
        <tr>
        ...
        <tr>
            <td class="modal-sm" style="width: 190px">
                <asp:Button ID="btnAgregar" runat="server" Text="Agregar" OnClick="btnIngresar_Click" OnClientClick="LimpiarCajasDeTexto()" />
                <asp:Button ID="btnModificar" runat="server" Text="Modificar" OnClick="btnModificar_Click" OnClientClick="LimpiarCajasDeTexto()"/>
            </td>
            <td>
                <asp:Button ID="btnEliminar" runat="server" Text="Eliminar" OnClick="btnEliminar_Click" OnClientClick="LimpiarCajasDeTexto()"/>
            </td>
            <td>&nbsp;</td>
        </tr>
        <tr>
